...
namespace StickyNotesApp
{
    public partial class ViewNoteForm: Form
    {
        ...
        public ViewNoteForm(StickyNote note)
        {
            this.note = note;
            InitializeComponent();
            LoadNoteData();
        ...
        private void LoadNoteData()
        {
            ...
            // Set the color in ComboBox
            string colorName = "Yellow"; // Default
            if (note.Color == Color.LightGreen)
                colorName = "Green";
            else if (note.Color == Color.LightPink)
                colorName = "Pink";
            else if (note.Color == Color.LightBlue)
                colorName = "Blue";
            else if (note.Color == Color.Green)
                colorName = "Green";
            else if (note.Color == Color.Black)
                colorName = "Black";
            else if (note.Color == Color.Orange)
                colorName = "Orange";
            else if (note.Color == Color.Brown)
                colorName = "Brown";
            else if (note.Color == Color.Red)
                colorName = "Red";
            else if (note.Color == Color.Purple)
                colorName = "Purple";

            colorComboBox.SelectedIndex = colorComboBox.Items.IndexOf(colorName);

            // Set the form's background color to match the note
            this.BackColor = note.Color;
        }
